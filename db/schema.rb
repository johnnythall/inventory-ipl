...
ActiveRecord::Schema.define(version: 20150305083919) do
  ...
  add_index "carts", ["asset_id"], name: "index_carts_on_asset_id"
  ...
  add_index "rentals", ["rented_by_id"], name: "index_rentals_on_rented_by_id"
